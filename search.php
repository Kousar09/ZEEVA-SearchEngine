...
<html>
<head>
	<title><?php if(isset($term) && $term != '') echo($term . ' | '); ?>Zeeva Search</title>
...
<body>
    <div class="wrapper">
        <div class="header">
			...
			<div class="logoContainer" style="margin: left 100px">
					<a href="index.php">
						<img src="assets/images/zeevaLogo.jpg" height="50px">
					</a>
				</div>
